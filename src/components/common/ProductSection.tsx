    ...
    <section id={id} className="py-16 md:py-24">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="mb-10 flex items-end justify-between">
          ...
          <Link to="/products" className="group hidden sm:flex items-center gap-2 text-sm font-semibold text-gray-500 hover:text-gray-900 transition-colors duration-300">
        ...
        <div className="mt-8 flex sm:hidden justify-center">
          <Link to="/products" className="flex items-center gap-2 text-sm font-semibold text-gray-500 hover:text-gray-900 transition-colors">
