  ...
  return (
    ...
    >
        ...
        {product.trangThai !== "HETHANG" && (
          <div className="absolute bottom-0 left-0 right-0 p-3 translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-out z-10">
            <Button
              ...
              className="w-full bg-gray-900/95 backdrop-blur-sm hover:bg-gray-800 text-white rounded-xl h-11 text-sm font-semibold shadow-xl"
            >
      ...
      <div className="flex flex-1 flex-col gap-1.5 p-4">
        <p className="text-[10px] font-bold text-orange-500 uppercase tracking-[0.15em]">
