    ...
    >
      <div className="relative aspect-square overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        {product.tag && !product.soldOut && (
          <Badge className="absolute top-3 left-3 bg-orange-500 text-white border-0 px-3 py-1 rounded-full text-[10px] tracking-wider font-bold shadow-lg shadow-orange-500/30">
            {product.tag}
          </Badge>
        )}
        {product.originalPrice && !product.soldOut && !product.tag && (
      ...
      <div className="flex flex-1 flex-col gap-1.5 p-4">
        <p className="text-[10px] font-bold text-orange-500 uppercase tracking-[0.15em]">{product.brand}</p>
